...
void setup() {
  ...
  // Partie NRF24
  Serial.println(radio.begin());                      // Initialisation du module NRF24
...
void loop() {
  ...
  if (radio.available()) {
    ...
    // ToDo : fix issue. Nano en receiver / Uno en sender
    // no data received -> https://arduino.stackexchange.com/questions/65249/nrf24l01-tmrh20-library-receiver-gets-blank-data
  }
  delay(1000);
}
